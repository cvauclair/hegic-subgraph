...
export class ETHLiquidityPool extends ethereum.SmartContract {
  static bind(address: Address): ETHLiquidityPool {
    return new ETHLiquidityPool("ETHLiquidityPool", address);
  }
